...
def index():
    info = {
        "message": "API de triángulo - endpoints disponibles",
        "endpoints": {
            "/api/triangulo (POST)": "Calcula área y perímetro, enviar JSON con base, altura, lado1, lado2",
            "/api/triangulo/ejemplo (GET)": "Ejemplo de uso"
        }
    }
...
def manejar_404(error):
    return jsonify({"error": "Not Found", "message": "Ruta no encontrada. Visita / para ver endpoints disponibles."}), 404
